...
${C.u("Methods:")}
  ...
  ${C.b("snippet")}  ${C.i("- tinchi snippet <name> <file.css>")}
    Appends a predefined CSS snippet (e.g. media query) to the target file.
    Use ${C.cB("tinchi snippet list")} to see available snippets.
`;
